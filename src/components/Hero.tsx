      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-3 bg-gradient-to-r from-white/90 to-white/80 backdrop-blur-md px-8 py-4 rounded-full shadow-xl shadow-primary/10 mb-10 border border-primary/10"
          >
            <motion.div
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-green-50 border-2 border-green-200 text-green-700 px-5 py-2.5 rounded-full text-sm font-bold mb-8"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold text-secondary mb-6 leading-tight"
          >
